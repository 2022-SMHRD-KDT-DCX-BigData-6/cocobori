			...
			<div class="tm-sidebar sticky">
				...
				<nav class="tm-main-nav">
					<ul class="tm-main-nav-ul">
						...
						<li class="tm-nav-item"><a href="index.html" class="tm-nav-item-link tm-button">메인</a></li>
						<li class="tm-nav-item"><a href="board.jsp" class="tm-nav-item-link tm-button">게시판</a></li>
						<li class="tm-nav-item"><a href="about.html" class="tm-nav-item-link tm-button">반려동물 정보</a></li>
						<li class="tm-nav-item"><a href="contact.html" class="tm-nav-item-link tm-button active">Contact</a></li>
					</ul>
				</nav>
			</div>
